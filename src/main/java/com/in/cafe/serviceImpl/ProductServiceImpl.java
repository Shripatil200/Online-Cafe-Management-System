...
public class ProductServiceImpl implements ProductService {
        ...
        try {
            if (jwtFilter.isAdmin()) {
                if (validateProductMap(requestMap, false)) {
                    productDao.save(getProduceFromMap(requestMap, false));
    ...
    private Product getProduceFromMap(Map<String, String> requestMap, Boolean isAdd) {
            ...
            if(jwtFilter.isAdmin()){
                if(validateProductMap(requestMap, true)){
                    ...
                    if(optional.isPresent()){
                        Product product = getProduceFromMap(requestMap, true);
